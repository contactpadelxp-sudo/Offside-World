...
>
> ## ✅ ÉTAT RÉEL APRÈS LA MISE EN LIGNE — relevé le 24 septembre 2026
>
> Sport-Finder, fiche « Location de terrain Offside » :
> **lundi–vendredi 18h00 → 00h00, samedi–dimanche 17h00 → 00h00.** Le Bubble
> Foot suit les heures du foot.
>
> **Plus rien ne se chevauche.** Tout ce que le site vend s'arrête pile à
> l'ouverture du foot : anniversaires à 18h00 le mercredi et le vendredi, à
> 17h00 le week-end ; team building à 13h00 ou 18h00. Bord à bord, sans
> battement entre deux groupes — c'est le réglage de Brahim.
>
> **Le team building n'a donc plus rien à fermer sur Sport-Finder**, matin ou
> après-midi. La règle « au cas par cas » écrite ici plus tôt dans la soirée
> reposait sur une ouverture du foot à 14h00 qui n'a jamais été configurée.
>
> `src/data/plages-sport-finder.ts` porte ces heures depuis ce relevé. Le
> tableau « Ce qu'il faut régler » plus bas est la cible du 21 septembre ; elle
> n'a pas été appliquée telle quelle et ne fait plus foi.
...
**Ce qu'il faut régler** *(cible du 21 septembre — REMPLACÉE par l'état réel
relevé le 24, voir plus haut)* — Sport-Finder → Horaires → Horaire
d'ouverture → *Détailler par jour* :
