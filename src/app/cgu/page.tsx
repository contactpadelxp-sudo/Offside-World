...
export const metadata: Metadata = {
  title: "Conditions Générales d'Utilisation | Offside World",
  description: "CGU du site Offside World — BELANTIS.",
};
    ...
    <div className="mx-auto max-w-4xl px-4 pt-24 pb-12 md:pt-28 md:pb-20">
      ...
      <section className="mt-8 space-y-4">
        ...
        <p className="text-muted-foreground">
          Le site offsideworld.be est accessible gratuitement à tout utilisateur disposant d&apos;un accès à Internet. BELANTIS met tout en œuvre pour assurer l&apos;accès au site 24h/24, 7j/7, mais ne saurait être tenu responsable en cas d&apos;interruption pour maintenance, mise à jour ou cause de force majeure.
        </p>
      </section>
      ...
      <section className="mt-8 space-y-4">
        ...
        <p className="text-muted-foreground">
          L&apos;ensemble des éléments du site (textes, images, logos, vidéos, design, code source) est protégé par les lois relatives à la propriété intellectuelle. Toute reproduction, représentation ou diffusion, totale ou partielle, sans autorisation écrite préalable de BELANTIS, est strictement interdite.
        </p>
      </section>
      ...
      <section className="mt-8 space-y-4">
        ...
        <p className="text-muted-foreground">
          BELANTIS s&apos;efforce d&apos;assurer l&apos;exactitude des informations publiées sur le site. Toutefois, BELANTIS ne saurait être tenu responsable des erreurs, omissions ou résultats obtenus suite à l&apos;utilisation de ces informations.
        </p>
        <p className="text-muted-foreground">
          BELANTIS décline toute responsabilité en cas de dommages directs ou indirects résultant de l&apos;accès ou de l&apos;utilisation du site, y compris l&apos;inaccessibilité, les pertes de données ou les virus.
        </p>
      </section>
      ...
      <section className="mt-8 space-y-4">
        ...
        <ul className="list-disc pl-6 space-y-1 text-muted-foreground">
          ...
          <li>Respecter les droits de propriété intellectuelle de BELANTIS</li>
        </ul>
      </section>
      ...
      <section className="mt-8 space-y-4">
        ...
        <p className="text-muted-foreground">
          BELANTIS se réserve le droit de modifier les présentes CGU à tout moment. Les modifications entrent en vigueur dès leur publication sur le site. L&apos;utilisateur est invité à consulter régulièrement cette page.
        </p>
      </section>
